...
(
    ...
    CONSTRAINT FK_ITEM_FOR_BOOKER FOREIGN KEY (booker_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT FK_ITEM_FOR_ITEMS FOREIGN KEY (item_id) REFERENCES items (id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT FK_ITEM_FOR_REQUESTER FOREIGN KEY (requester_id) REFERENCES users (id)
);
